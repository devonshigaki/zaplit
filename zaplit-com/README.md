...
The main marketing website for Zaplit - AI agent teams deployment platform.

## Overview

This Next.js application serves as the primary landing page and marketing site for Zaplit, featuring:

- **Hero Section** - Main value proposition and CTAs
- **Solutions Section** - Industry-specific use cases with tabbed navigation
- **Features Section** - Platform capabilities showcase
- **Pricing Section** - Plan comparison and calculator
- **Blog** - Technical articles and company updates
- **Contact Forms** - Consultation booking and newsletter signup
...
# Deploy to Cloud Run
gcloud run deploy zaplit-com --source .
```
