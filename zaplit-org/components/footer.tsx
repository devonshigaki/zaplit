      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
              AI agents for nonprofits. Amplifying impact through secure, affordable automation so you can focus on your mission.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="/mission" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Mission</a>
              <a href="/impact" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Impact Stories</a>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-4">Resources</h4>
            <div className="space-y-3">
              <a href="/nonprofit-guide" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Nonprofit Guide</a>
              <a href="/security-whitepaper" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Security Whitepaper</a>
              <a href="#faq" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">FAQ</a>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Zaplit.org. All rights reserved.
          </p>
