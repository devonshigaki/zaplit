...
const agentData = [
  { id: "secretary", name: "Coordinator", icon: Workflow, salary: 55000, buildCost: 12000, maintenance: 2400 },
  { id: "research", name: "Impact Analyst", icon: Search, salary: 65000, buildCost: 10000, maintenance: 1800 },
  { id: "security", name: "Finance Assistant", icon: Shield, salary: 55000, buildCost: 18000, maintenance: 3000 },
  { id: "marketing", name: "Communications", icon: Megaphone, salary: 58000, buildCost: 14000, maintenance: 2400 },
  { id: "lead", name: "Grant Writer", icon: UserPlus, salary: 70000, buildCost: 12000, maintenance: 2000 },
  { id: "billing", name: "Donor Relations", icon: Receipt, salary: 60000, buildCost: 10000, maintenance: 1800 },
  { id: "support", name: "Volunteer Manager", icon: HeadphonesIcon, salary: 52000, buildCost: 8000, maintenance: 1200 },
]
    ...
    <section id="calculator" className="py-32 border-t border-border">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-2xl mb-16">
          <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-4">Impact Calculator</p>
          <h2 className="text-4xl md:text-5xl font-serif italic mb-6 text-balance">
            Calculate your impact potential
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Compare the cost of staff time versus AI agents. Redirect savings toward your mission.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            {/* Agent Selection */}
            <div>
              <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-wider mb-4">Select Support Areas</h3>
              ...
              <p className="text-xs text-muted-foreground mt-2">Coordinator is always included as the orchestrator</p>
            </div>

            {/* Team Size Slider */}
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Program scale</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Projection period</h3>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-muted-foreground">Staff time cost</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-muted-foreground">AI support cost</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card border border-border rounded-xl p-6">
                <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-2">Funds Redirected to Mission</p>
              ...
              <div className="bg-card border border-border rounded-xl p-6">
                <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-2">Break-even</p>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-2">Annual Mission Funding</p>
