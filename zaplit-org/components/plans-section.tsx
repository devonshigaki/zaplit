...
const plans = [
  {
    id: "programs",
    name: "Programs",
    description: "Program delivery, volunteer coordination, and impact measurement",
    agents: [{ name: "Coordinator", icon: Workflow }],
    features: ["Workflow orchestration", "Task delegation", "Priority management", "Cross-team coordination"],
  },
  {
    id: "development",
    name: "Development",
    description: "Fundraising, donor relations, and grant management",
    agents: [
  ...
  },
  {
    id: "operations",
    name: "Operations",
    description: "Administration, finance, and communications",
    agents: [
    ...
    <section id="plans" className="py-32 border-t border-border">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-2xl mb-16">
          <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-4">Nonprofit Plans</p>
          <h2 className="text-4xl md:text-5xl font-serif italic mb-6 text-balance">
            Scale your impact, not your overhead
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Select the departments you need. All configurations include the Coordinator orchestrator. Pricing is designed for nonprofit budgets.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">All 6 agents across all departments</p>
              </div>
            </div>
            <div className="flex gap-2">
        ...
        <div className="text-center">
          <p className="text-sm text-muted-foreground mb-4">
            {selectedPlans.length > 0
              ...
              : "Select focus areas to configure your impact team"}
          </p>
          {selectedPlans.length > 0 ? (
            <Button size="lg" asChild>
              <a href="#book-demo">Schedule a Conversation</a>
            </Button>
          ) : (
          ...
          <p className="text-xs text-muted-foreground mt-3">Nonprofit pricing based on budget and scope</p>
        </div>
      </div>
    </section>
  )
