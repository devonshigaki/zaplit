...
export function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center pt-16 pb-24 md:pt-20 md:pb-32 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif italic leading-[1.1] tracking-tight text-balance">
